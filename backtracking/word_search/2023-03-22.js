...
const exist = (board, word) => {
    ...
    const dfs = (row, column, currentIndexOfWord) => {
        ...
        if (
            row < 0 || column < 0 || row >= num_rows || column >= num_cols || (word[currentIndexOfWord] !== board[row][column]) || path.has(seenKey)
        ) return false
...
log(exist(board, "ABCCED"))

log(exist([["A","B","C","E"],["S","F","C","S"],["A","D","E","E"]], "ABCB")) //false