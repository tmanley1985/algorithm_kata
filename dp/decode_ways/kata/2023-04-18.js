...
const decodeWays = str => {
    ...
    const dfs = i => {
        ...
        (
          str[i] === '1' || // if double-digit value starts with 1 and there is a second digit then we have a valid double-digit value that starts with 1 ex: 10 - 19
...
log(decodeWaysTab("12")) // 2
log(decodeWaysTab("226")) // 3
log(decodeWaysTab("121")) // 3
